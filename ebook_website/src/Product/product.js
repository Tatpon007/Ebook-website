            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center">
                        <button class="bg-green-200 p-2 rounded-full mr-4 hover:bg-green-300 focus:outline-none focus:bg-green-300">
                            {/* <img src="" alt="Read Sample" class="w-6 h-6"> */}
                        </button>
                        <p class="text-sm text-green-600 font-semibold cursor-pointer">Read Sample</p>
                    </div>
