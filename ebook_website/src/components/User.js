        ...
        <div>
                ...
                <div className='container mx-auto px-4 py-8'>
                    ...
                    <div className='boxs'>
                        <ul>
                            ...
                            <input type="text" className="block w-full p-1 ps-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 
                            ...
                            dark:focus:border-blue-500" style={{ width: '20rem' }} placeholder="Username" ></input>
                        </ul>
                        ...
                        <ul className='a' style={{ marginLeft: '2rem' }}>
                            ...
                            <input type="text" className="block w-full p-1 ps-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 
                            focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
                            dark:focus:border-blue-500" style={{ width: '20rem' }} placeholder="Email" ></input>
                        </ul>
                        ...
                        <ul className='a' style={{ marginTop: '10rem', marginLeft: '-20rem' }}>
                            ...
                            <input type="text" className="block w-full p-1 ps-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 
                            focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
                            dark:focus:border-blue-500" style={{ width: '20rem' }} placeholder="Phone Number" ></input>
                        </ul>

                        <div className='b' style={{ marginTop: '15rem', marginLeft: '-14rem' }}>
                            <Link to="/EDIT" class="bg-green-500 text-white px-6 py-2 rounded-full hover:bg-green-600 focus:outline-none 
                            focus:bg-green-600">EDIT</Link>
                        </div>
                    </div>
            ...
            <Modal isOpen={modalIsOpen5} onRequestClose={closeModal5} style={{ content: { width: '25%', height: '50%', margin: 'auto' } }}>
                <div className='lo'>
                    ...
                    <form>
                        <div className="user"><h1 className='flex text-sm'>You will not be able to log in again to this account if you delete your account.</h1>
                        </div>
