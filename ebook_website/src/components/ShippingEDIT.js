                ...
                <div className='container mx-auto px-4 py-8'>
                    ...
                    <div className='boxs'>
                        <ul>
                            ...
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" style={{ width: '20rem' }} placeholder="Username" ></input>
                        </ul>
                        ...
                        <div className='b' style={{ marginTop: '15rem', marginLeft: '-30rem' }}>
                            <Link to="/Shipping" class="bg-green-500 text-white px-6 py-2 rounded-full hover:bg-green-600 focus:outline-none 
                            focus:bg-green-600">CONFIRM</Link>
                        </div>
                        <div className='b' style={{ marginTop: '15rem', marginLeft: '-15rem' }}>
                            <Link to="/Shipping" class="bg-green-500 text-white px-6 py-2 rounded-full hover:bg-green-600 focus:outline-none 
                            focus:bg-green-600">CANCEL</Link>
                        </div>
                    </div>
                </div>
            </div>
