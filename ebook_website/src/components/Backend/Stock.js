        ...
        <div class="overflow-x-auto w-11/12">
          <table class="w-full bg-white shadow-md rounded border border-gray-300">
            <thead class="bg-green-500 text-white">
              <tr>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm border-b border-gray-300">Ebook Id</th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm border-b border-gray-300">Ebook Name</th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm border-b border-gray-300">Categories</th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm border-b border-gray-300">Price</th>
            ...
            <tbody class="text-gray-700">
              ...
              <tr>
                ...
                <td class="text-left py-3 px-4 border-b border-gray-300">Ebookname1</td>
                <td class="text-left py-3 px-4 border-b border-gray-300">Sciences</td>
                <td class="text-left py-3 px-4 border-b border-gray-300">240</td>
